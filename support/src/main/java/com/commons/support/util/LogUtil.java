...
public class LogUtil {
    ...
    public static void saveLog(String fileName, String logStr, Throwable throwable) {
        ...
        try {
            ...
            logFilePath = DirUtil.getStoragePath(DirUtil.LOG_PATH) + fileName;
            //没有挂载SD卡，无法写文件
...
//        final Context activity = MApplication.getAppContext();//AppManager.getAppManager().currentActivity();
