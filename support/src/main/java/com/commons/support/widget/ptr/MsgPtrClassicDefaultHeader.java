...
public class MsgPtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    public MsgPtrClassicDefaultHeader(Context context) {
        super(context);
        initViews(null);
    }

    public MsgPtrClassicDefaultHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public MsgPtrClassicDefaultHeader(Context context, AttributeSet attrs, int defStyle) {
