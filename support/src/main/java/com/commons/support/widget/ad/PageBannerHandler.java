 ...
 */
public class PageBannerHandler extends Handler {

    private String TAG = "PageBannerHandler";
    /**
     * 请求更新显示的View。
     */
    ...
    public PageBannerHandler(ViewPager viewPager, int initCurrentItem, WeakReference<?> wk) {
